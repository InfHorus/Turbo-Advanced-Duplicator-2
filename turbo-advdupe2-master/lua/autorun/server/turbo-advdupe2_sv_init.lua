...
AddCSLuaFile( "autorun/client/turbo-advdupe2_cl_init.lua" )
AddCSLuaFile( "turbo-advdupe2/file_browser.lua" )
AddCSLuaFile( "turbo-advdupe2/sh_codec.lua" )
AddCSLuaFile( "turbo-advdupe2/cl_file.lua" )
AddCSLuaFile( "turbo-advdupe2/cl_ghost.lua" )
...
include( "turbo-advdupe2/sv_clipboard.lua" )
include( "turbo-advdupe2/sh_codec.lua" )
include( "turbo-advdupe2/sv_misc.lua" )
include( "turbo-advdupe2/sv_file.lua" )
include( "turbo-advdupe2/sv_ghost.lua" )
