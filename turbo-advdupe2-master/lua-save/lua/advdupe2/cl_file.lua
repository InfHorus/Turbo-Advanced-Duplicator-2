...
hook.Add("ExpressLoaded", "AdvDupe2_FileSetup", function()
    express.Receive("AdvDupe2_SetDupeInfo", function(data)
        if not data then return end
        
        AdvDupe2.Info.File:SetText("File: " .. (data.filename or ""))
        AdvDupe2.Info.Creator:SetText("Creator: " .. (data.creator or ""))
        AdvDupe2.Info.Date:SetText("Date: " .. (data.date or ""))
        AdvDupe2.Info.Time:SetText("Time: " .. (data.time or ""))
        AdvDupe2.Info.Size:SetText("Size: " .. (data.size or ""))
        AdvDupe2.Info.Desc:SetText("Desc: " .. (data.desc or ""))
        AdvDupe2.Info.Entities:SetText("Entities: " .. (data.entities or "0"))
        AdvDupe2.Info.Constraints:SetText("Constraints: " .. (data.constraints or "0"))
    end)

    express.Receive("AdvDupe2_ResetDupeInfo", function()
